...
for project_key in project_key_order:
    ...
    accounts = sorted({
        ...
        for value in project_rows["总账科目"]
...
df_summary["转出科目"] = df_summary["总账科目"].apply(normalize_code)
...
try:
    ...
    write_dataframe(sheet_summary, df_summary)
